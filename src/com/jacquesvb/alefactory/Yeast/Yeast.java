...
public class Yeast {
    ...
    public String toString() {
        return "com.jacquesvb.alefactory.Yeast.com.jacquesvb.alefactory.Yeast [name=" + name + ", description=" + description + ", floc=" + floc + ", lowAttenuation=" + lowAttenuation + ", highAttenuation=" +
